...
class NumbaEngine(OMVEngine):
    ...
    def is_installed(version):
        ...
        try:
            ...
            ret_str = sp.check_output(['python -c "import numba; print(numba.__version__)"'], shell=True,stderr=sp.STDOUT)
            ret = len(ret_str) > 0
            ...
            if is_verbose():
                inform("numba %s is correctly installed..." % ret, indent=2, verbosity=2)

        except Exception as err:
            inform("Couldn't import numba into Python: ", err, indent=1, verbosity=2)
            ret = False
        return ret
